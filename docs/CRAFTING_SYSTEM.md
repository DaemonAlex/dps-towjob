...
```
Player approaches workbench
        ↓
ox_target shows "[E] Tow Shop Workbench"
        ↓
Player interacts → Opens crafting UI
        ↓
UI shows recipes (filtered by grade)
        ↓
...
Progress bar with animation
        ↓
Success/Fail based on chance
        ↓
Item added to inventory (or materials lost on fail)
```
